...
define gui.text_font = gui.preference("font", "SourceHanSansLite.ttf")
# The text font for buttons
define gui.interface_text_font = gui.preference("interface_font", "SourceHanSansLite.ttf")
# The default size of in-game text
define gui.text_size = gui.preference("size", 33)
# The font for character names
define gui.name_text_font = gui.preference("name_font", "SourceHanSansLite.ttf")
